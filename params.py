...
class Parameterise(object):
    def __init__(self, vdw_defs, paramfile ='params/oplsaa.prm'):
        ...
        print 'Atom label -> OPLS vdw definitions:'
        print self.vdw_defs
        print
        print 'Atom label -> OPLS type definitions:'
        print self.type_defs
        print
    ...
    def match_charges(self):
        ...
        for label in self.vdw_defs:
            ...
            if found != 1:
                raise ValueError('WRONG',label,'\t found ',found,' charges entries')
    ...
    def match_masses(self):
        ...
        for label in self.vdw_defs:
            ...
            if found != 1:
                raise ValueError('WRONG',label,'\t found ',found,' masses entries')
        return mass_coeffs
    ...
    def match_pairs(self):
        ...
        for label in self.vdw_defs:
            ...
            if found != 1:
                raise ValueError('WRONG',label,'\t found ',found,' pair entries')
        return pair_coeffs
    ...
    def match_bonds(self, bond_types):
        ...
        for i in range(len(bond_types)):
            ...
            if found != 1:
                raise ValueError('WRONG',atoms,'\t found ',found,' bond entries')
        return bond_coeffs
    ...
    def match_angles(self, angle_types):
        ...
        for i in range(len(angle_types)):
            ...
            if found != 1:
                 ...
                 print 'WRONG',atoms,'\t found ',found,' angle entries'
    ...
    def match_torsions(self, torsion_types):
        ...
        for i in range(len(torsion_types)):
            ...
            if found == 0:
                if atoms == [44, 13, 13, 20] or atoms == [44, 13, 13, 20]:
                    atoms = [20, 13, 13, 20]
                    torsion_coeffs, found = search_torsions(torsion_data, atoms,
                                                    torsion_coeffs)
                    if found != 0:
                        print found, [a1,a2,a3,a4], atoms, 'made NCCO substitution'

            if found != 1:
                #raise ValueError('WRONG',atoms,'\t found ',found,' entries')
                print 'WRONG',[a1,a2,a3,a4],'\t found ',found,' torsion entries'
        if questionable != 0:
    ...
    def match_impropers(self, improper_types):
        ...
        for i in range(len(improper_types)):
            ...
            if found != 1:
                 #raise ValueError('WRONG',atoms,'\t found ',found,' entries')
                 print 'WRONG',centre,neighbours,'\t found ',found,' improper entries'
